...
resource "aws_iam_role_policy_attachment" "amazon-eks-worker-node-policy" {
    policy_arn = "arns:aws:iam::aws:policy/AmazonEKSWorkerNodepolicy"
...
resource "aws_iam_role_policy_attachment" "amazon-ec2-container-registry-policy" {
...
resource "aws_eks_node_group" "private_nodes" {
    ...
    depends_on = [ 
        ...
        aws_iam_role_policy_attachment.amazon-ec2-container-registry-policy,
